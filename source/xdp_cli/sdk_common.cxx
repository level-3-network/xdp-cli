...
void SDK_Common::initialize_application_arguments(int number_of_arguments, char* arguments[])
{
...
bool SDK_Common::application_arguments_contains_flag(const std::string& flag) {
    return std::find(this->application_arguments_.begin(), this->application_arguments_.end(), flag) != this->application_arguments_.end();
}

std::string SDK_Common::get_application_argument_value(const std::string& argument, const std::string& default_value)
{
...
bool SDK_Common::is_numeric_string(const std::string& string)
{
