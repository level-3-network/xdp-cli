...
struct
{
    ...
    __type(key, struct LPM_TrieKey_IPv4);
    __type(value, struct TrafficShaper_TokenBucket);
    __uint(map_flags, BPF_F_NO_PREALLOC);
...
static __always_inline int parse_packet(struct xdp_md* ctx, struct BPF_PacketContext* packet_ctx)
{
...
static __always_inline int check_and_consume_tokens(struct TrafficShaper_TokenBucket* token_bucket, __u64 packet_length)
{
...
static __always_inline int process_blacklisted_ipv4_addresses(struct BPF_PacketContext* packet_ctx, __u32* ingress_ifindex)
{
    struct LPM_TrieKey_IPv4 key = {};

    key.prefix_length = 32;

    if (*ingress_ifindex == wan_if_index)
    {
...
static __always_inline int process_blacklisted_ipv6_addresses(struct BPF_PacketContext* packet_ctx, __u32* ingress_ifindex)
{
...
static __always_inline int process_traffic_shaped_ipv4_addresses(struct BPF_PacketContext* packet_ctx, __u32* ingress_ifindex)
{
    struct LPM_TrieKey_IPv4 key = {};
    ...
    struct TrafficShaper_TokenBucket* token_bucket = bpf_map_lookup_elem(&traffic_shaper_ipv4_addresses_map, &key);
...
static __always_inline int process_traffic_shaped_ipv6_addresses(struct BPF_PacketContext* packet_ctx, __u32* ingress_ifindex)
{
    struct LPM_TrieKey_IPv6 key = {};
    ...
    struct TrafficShaper_TokenBucket* token_bucket = bpf_map_lookup_elem(&traffic_shaper_ipv6_addresses_map, &key);
...
{
    struct BPF_PacketContext packet_ctx = {};
